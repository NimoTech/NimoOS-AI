...
readonly CASA_EXEC=nimoos-ai
readonly CASA_SERVICE=nimoos-ai.service
...
rm -rvf /var/run/nimoos/ai.pid
rm -rvf /var/run/nimoos/ai.url
rm -rvf /var/lib/nimoos/ai
